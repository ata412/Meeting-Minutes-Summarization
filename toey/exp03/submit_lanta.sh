...
#SBATCH --output=/lustrefs/disk/project/zz991000-zdeva/zz991021/logs/exp03_%j.out
#SBATCH --error=/lustrefs/disk/project/zz991000-zdeva/zz991021/logs/exp03_%j.err
...
export RESULT_DIR="$PROJECT/toey/exp03/result"
...
echo "=== exp03: Qwen3-32B-AWQ + BM25/bge-m3 RRF ==="
